  ...
  return (
    <div className="flex h-screen bg-[#FFFBE9] overflow-hidden">
      ...
      >
        ...
        <div className="px-3 py-4 border-t border-[#E8E0D0]">
          <button
        ...
        <header className="h-24 flex-shrink-0 bg-[#FFFBE9] border-b border-[#E8E0D0] flex items-center px-4 sm:px-8 gap-4 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-3">
            ...
            {user?.image ? (
              ...
              <div className="w-10 h-10 rounded-full bg-[#724A6A] flex items-center justify-center text-white text-sm font-bold cursor-pointer">
                {initials}
              </div>
            )}
          </div>
