    ...
    <div className="flex h-screen bg-[#FFFBE9] overflow-hidden">
      ...
      >
        <div className="h-24 flex items-center px-6 border-b border-[#E8E0D0] flex-shrink-0">
          ...
          <span className="badge bg-[#F5EDF4] text-[#724A6A] border border-[#D4B8CF] text-[10px] ml-2">
            Organiser
          </span>
        </div>
        ...
        <div className="px-3 py-4 border-t border-[#E8E0D0] flex flex-col gap-1">
          <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-[#4A4A6A] hover:bg-[#FFFBE9] transition-colors">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        <header className="h-24 flex-shrink-0 bg-[#FFFBE9] border-b border-[#E8E0D0] flex items-center px-4 sm:px-8 gap-4 sticky top-0 z-30">
          <button
            className="lg:hidden p-2 rounded-lg hover:bg-[#F5EDF4] text-[#4A4A6A]"
          ...
          <div className="flex items-center gap-3">
            ...
            {user?.image ? (
              ...
              <div className="w-10 h-10 rounded-full bg-[#D4A017] flex items-center justify-center text-white text-sm font-bold">
                {initials}
              </div>
            )}
          </div>
